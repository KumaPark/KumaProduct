...
public class ResModelOSList extends ResponseProtocol{
    ...
    protected void parseXMLResponseData(JSONObject jsonObject) {
        try {
            KumaLog.d("============ ResModelOSList parseXMLResponseData  ");
            ...
            KumaLog.i("+++ ResModelOSList STR_TAG_RESULT  " + m_strResult);
            KumaLog.i("+++ ResModelOSList STR_TAG_MSG  " + m_strMsg);
