...
public class ResDestinationList extends ResponseProtocol{
    ...
    protected void parseXMLResponseData(JSONObject jsonObject) {
        try {
            KumaLog.d("============ ResDestinationList parseXMLResponseData  ");
            ...
            KumaLog.i("+++ ResDestinationList STR_TAG_RESULT  " + m_strResult);
            KumaLog.i("+++ ResDestinationList STR_TAG_MSG  " + m_strMsg);
