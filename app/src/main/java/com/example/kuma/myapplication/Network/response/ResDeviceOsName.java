...
public class ResDeviceOsName extends ResponseProtocol{
    ...
    protected void parseXMLResponseData(JSONObject jsonObject) {
        try {
            KumaLog.d("============ ResDeviceOsName parseXMLResponseData  ");
            ...
            KumaLog.i("+++ ResDeviceOsName STR_TAG_RESULT  " + m_strResult);
            KumaLog.i("+++ ResDeviceOsName STR_TAG_MSG  " + m_strMsg);
