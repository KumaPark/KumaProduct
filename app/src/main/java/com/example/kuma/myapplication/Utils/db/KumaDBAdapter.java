...
public class KumaDBAdapter extends CursorAdapter {
	...
	public boolean createTable() {
		...
		try {
			mDatabase.query(KumaDBConstants.TABLE_CUSTOMER_MAIN, null, null,
					null, null, null, null);
		} catch (Exception e) {
			try {
				mDatabase
						.execSQL(KumaDBConstants.SQL_CREATE_TABLE_CUSTOMER_MAIN);
			} catch (Exception e1) {
				e1.printStackTrace();
				return false;
			}
		...
		// ?�뛰??매정?�보 버전 ?�이�?
		try {
			mDatabase.query(KumaDBConstants.TABLE_CUSTOMER_SUB, null, null,
					null, null, null, null);
		} catch (Exception e) {
			try {
				mDatabase
						.execSQL(KumaDBConstants.SQL_CREATE_TABLE_CUSTOMER_SUB);
			} catch (Exception e1) {
				e1.printStackTrace();
				return false;
			}
		...
		// ?�뛰??매정?�보 버전 ?�이�?
		try {
			mDatabase.query(KumaDBConstants.TABLE_CUSTOMER_CONTRACT, null, null,
					null, null, null, null);
		} catch (Exception e) {
			try {
				mDatabase
						.execSQL(KumaDBConstants.SQL_CREATE_TABLE_CUSTOMER_CONTRACT);
			} catch (Exception e1) {
				e1.printStackTrace();
				return false;
			}
		...
		// ?�뛰??매정?�보 버전 ?�이�?
		try {
			mDatabase.query(KumaDBConstants.TABLE_CONTACT_LIST, null, null,
					null, null, null, null);
		} catch (Exception e) {
			try {
				mDatabase
						.execSQL(KumaDBConstants.SQL_CREATE_TABLE_CONTACT_LIST);
			} catch (Exception e1) {
				e1.printStackTrace();
				return false;
			}
		...
		KumaLog.d("test"," dd  " + KumaDBConstants.SQL_CREATE_TABLE_CUSTOMER_EVENT );

		// ?�뛰??매정?�보 버전 ?�이�?
		try {
			mDatabase.query(KumaDBConstants.TABLE_CUSTOMER_EVENT, null, null,
					null, null, null, null);
		} catch (Exception e) {
			try {
				mDatabase
						.execSQL(KumaDBConstants.SQL_CREATE_TABLE_CUSTOMER_EVENT);
			} catch (Exception e1) {
				e1.printStackTrace();
				return false;
			}
