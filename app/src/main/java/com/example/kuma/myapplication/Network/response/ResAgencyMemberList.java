...
public class ResAgencyMemberList extends ResponseProtocol{
    ...
    protected void parseXMLResponseData(JSONObject jsonObject) {
        try {
            KumaLog.d("============ ResAgencyMemberList parseXMLResponseData  ");
            ...
            KumaLog.i("+++ ResAgencyMemberList STR_TAG_RESULT  " + m_strResult);
            KumaLog.i("+++ ResAgencyMemberList STR_TAG_MSG  " + m_strMsg);
